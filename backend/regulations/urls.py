...
urlpatterns = [
    ...
    path('documentos/upload-texto/', views.upload_texto, name='upload-texto'),
    path('documentos/<slug:slug>/', views.detalhe_documento, name='detalhe-documento'),
    path('documentos/<slug:slug>/delete/', views.excluir_documento, name='excluir-documento'),
    path('documentos/<slug:slug>/atualizar/', views.atualizar_documento, name='atualizar-documento'),
